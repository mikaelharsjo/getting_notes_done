class ActionFetcher
	...
	def fetch success
		filter = EDAMNoteFilter.alloc.initWithOrder 0, ascending:false, words:nil, notebookGuid: @filter.notebook_guid, tagGuids: @filter.tag_guids, timeZone:nil, inactive:false, emphasized:nil
